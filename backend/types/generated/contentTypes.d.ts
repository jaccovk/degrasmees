...
export interface ApiFormBuilderFormBuilder extends Struct.CollectionTypeSchema {
  collectionName: 'form_builders';
  info: {
    description: '';
    displayName: 'Formulieren';
  ...
  attributes: {
    ...
    fields: Schema.Attribute.DynamicZone<
      [
        ...
        'form.selectfield',
        'form.datefield',
        'form.pill-group-field',
        'form.chip-input-field',
    ...
    >;
    mailTemplate: Schema.Attribute.Relation<
      'oneToOne',
    ...
    publishedAt: Schema.Attribute.DateTime;
    submit: Schema.Attribute.Component<'link.button', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '';
    displayName: 'Globale instellingen';
    pluralName: 'globals';
    singularName: 'global';
  };
  options: {
  ...
  attributes: {
    ...
    personaldata: Schema.Attribute.Component<'layout.personaldata', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    meta: Schema.Attribute.Component<'layout.meta', false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useOverlay: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiMailTemplateMailTemplate
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customEmailFrom: Schema.Attribute.Email &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiSubmissionSubmission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reCaptchaVerify: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiThemeTheme extends Struct.SingleTypeSchema {
  ...
  attributes: {
    colors: Schema.Attribute.Component<'layout.colors', false> &
      Schema.Attribute.Required;
